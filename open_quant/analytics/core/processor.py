...
from open_quant.analytics.common import TYPE, PROCESSOR, PARAMETERS, DATA_COORDINATE, \
    ENTITY, VALUE, DATE, DATETIME, PROCESSOR_NAME, ENTITY_ID, ENTITY_TYPE, PARAMETER, REFERENCE, RELATIVE_DATE, LIST
from open_quant.analytics.common.enumerators import ScaleShape
from open_quant.analytics.common.helpers import is_of_builtin_type, get_entity_rdate_key_from_rdate
from open_quant.analytics.core.processor_result import ProcessorResult
from open_quant.data import DataCoordinate, DataFrequency
from open_quant.data.query import DataQuery, DataQueryType
from open_quant.entities.entity import Entity
from open_quant.target.common import Currency
from open_quant.timeseries import Window, Returns, RelativeDate, DateOrDatetime
...
class BaseProcessor(metaclass=ABCMeta):
    ...
    def from_dict(cls, obj: Dict, reference_list: List):
        ...
        processor = getattr(__import__('open_quant.analytics.processors', fromlist=['']), processor_name, None)
