...
from open_quant.base import Market
from open_quant.common import AssetClass, AggregationLevel, RiskMeasure
from open_quant.target.common import RiskMeasureType, RiskMeasureUnit
from open_quant.target.measures import IRBasis, IRVega, IRDelta, IRXccyDelta, InflationDelta
...
class __RelativeRiskMeasure(RiskMeasure):
    ...
    def pricing_context(self):
        from open_quant.markets import PricingContext, RelativeMarket
...
class PnlExplainLive(PnlExplain):
    ...
    def __init__(self):
        from open_quant.markets import LiveMarket
