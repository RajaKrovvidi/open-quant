...
import pandas as pd
from open_quant.base import Priceable, RiskKey, Sentinel, InstrumentBase, is_instance_or_iterable, is_iterable, Scenario
from open_quant.common import RiskMeasure
from open_quant.config import DisplayOptions
from open_quant.risk import DataFrameWithInfo, ErrorValue, FloatWithInfo, SeriesWithInfo, ResultInfo, \
    ScalarWithInfo, aggregate_results
from open_quant.risk.transform import Transformer
...
def _value_for_date(result: Union[DataFrameWithInfo, SeriesWithInfo], date: Union[Iterable, dt.date]) -> \
    ...
    from open_quant.markets import CloseMarket
...
def _risk_keys_compatible(lhs, rhs) -> bool:
    from open_quant.markets import historical_risk_key
