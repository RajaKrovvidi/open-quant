...
from open_quant.api.oq.data import QueryType, GsDataApi
from open_quant.errors import MqValueError
from open_quant.markets.securities import AssetIdentifier, Asset, SecurityMaster
from open_quant.target.common import AssetClass, AssetType, PricingLocation
from open_quant.timeseries import ASSET_SPEC, plot_measure, MeasureDependency
from open_quant.timeseries import ExtendedSeries, measures_rates as tm_rates
from open_quant.timeseries import measures as tm
from open_quant.timeseries.measures import _asset_from_spec, _market_data_timed, _cross_stored_direction_helper, \
    _preprocess_implied_vol_strikes_fx, _tenor_month_to_year
from open_quant.timeseries.measures_helper import VolReference
from open_quant.data.log import log_debug
...
def _get_tdapi_fxo_assets(**kwargs) -> Union[str, list]:
    ...
    assets = OqAssetApi.get_many_assets(**kwargs)
...
def _get_tdapi_fxo_assets_vol_swaps(**kwargs) -> Union[str, list]:
    ...
    assets = OqAssetApi.get_many_assets(**inputs)
