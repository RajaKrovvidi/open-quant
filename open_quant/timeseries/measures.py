...
from open_quant.data.fields import Fields
from open_quant.data.log import log_debug, log_warning
from open_quant.datetime.gscalendar import GsCalendar
from open_quant.datetime.point import relative_date_add
from open_quant.markets.securities import *
from open_quant.markets.securities import Asset, AssetIdentifier, SecurityMaster, AssetType as SecAssetType
from open_quant.target.common import AssetClass, AssetType
from open_quant.timeseries import volatility, Window, Returns, sqrt, Basket, RelativeDate
from open_quant.timeseries.helper import (
    log_return,
    plot_measure,
    _to_offset,
...
from open_quant.timeseries.measures_helper import EdrDataReference, VolReference, preprocess_implied_vol_strikes_eq
...
def convert_asset_for_rates_data_set(from_asset: Asset, c_type: RatesConversionType) -> str:
    try:
        ...
        identifiers = OqAssetApi.map_identifiers(GsIdType.mdapi, GsIdType.id, [to_asset])
...
def _var_swap_tenors(asset: Asset, request_id=None):
    ...
    body = OqSession.current._get(f"/data/markets/{aid}/availability")
...
def eu_ng_hub_to_swap(asset_spec: ASSET_SPEC) -> str:
    ...
    try:
        ...
        if asset.asset_class is AssetClass.Commod and asset.get_type() == SecAssetType.COMMODITY_EU_NATURAL_GAS_HUB:
            ...
            instruments = OqAssetApi.get_many_assets(**kwargs)
