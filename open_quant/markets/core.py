...
from open_quant.base import InstrumentBase, RiskKey, Scenario, get_enum_value
from open_quant.common import PricingLocation, RiskMeasure
from open_quant.context_base import ContextBaseWithDefault
from open_quant.datetime.date import business_day_offset, today
from open_quant.risk import CompositeScenario, DataFrameWithInfo, ErrorValue, FloatWithInfo, MarketDataScenario, \
    StringWithInfo
from open_quant.risk.results import PricingFuture
from open_quant.session import OqSession
from open_quant.target.common import PricingDateAndMarketDataAsOf
from open_quant.target.risk import RiskPosition, RiskRequest, RiskRequestParameters
from open_quant.tracing import Tracer
...
class PricingContext(ContextBaseWithDefault):
    ...
    def _calc(self, instrument: InstrumentBase, risk_key: RiskKey) -> PricingFuture:
        ...
        from open_quant.instrument import DummyInstrument
...
class PositionContext(ContextBaseWithDefault):
    ...
    def __init__(self,
        ...
        **Examples**
        ...
        >>> from open_quant.markets import PositionContext
        >>> import datetime
        >>>
