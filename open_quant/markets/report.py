...
from open_quant.api.oq.reports import GsReportApi, OrderType, FactorRiskTableMode
from open_quant.api.oq.thematics import Region, GsThematicApi, ThematicMeasure
from open_quant.datetime import business_day_offset
from open_quant.errors import MqValueError
from open_quant.markets.report_utils import _get_ppaa_batches
from open_quant.target.common import ReportParameters, Currency
from open_quant.target.coordinates import MDAPIDataBatchResponse
from open_quant.target.data import DataQuery, DataQueryResponse
from open_quant.target.reports import Report as TargetReport, ReportType, PositionSourceType, ReportStatus
...
class Report:
    ...
    def run(self,
        ...
        while counter > 0:
            try:
                ...
                raise MqValueError(
                    ...
                    'Marquee Analytics team at oq-marquee-analytics-support@oq.com')
            except IndexError:
                counter -= 1
        ...
        raise MqValueError(f'Your report {self.id} is taking longer to run than expected. '
                           'Please reach out to the Marquee Analytics team at oq-marquee-analytics-support@oq.com '
                           'for assistance.')
