...
from open_quant.entities.entity import PositionedEntity, EntityType
...
from open_quant.markets.report import PerformanceReport
from open_quant.markets.report import ReportJobFuture
from open_quant.markets.portfolio_manager_utils import build_exposure_df, build_portfolio_constituents_df, \
    build_sensitivity_df, build_macro_portfolio_exposure_df
from open_quant.models.risk_model import MacroRiskModel, ReturnFormat, FactorType, DataAssetsRequest, \
...
class PortfolioManager(PositionedEntity):
    ...
    def get_macro_exposure_table(self,
        ...
        assets_data = OqAssetApi.get_many_assets_data_scroll(fields=['name', 'gsid', 'id'],
