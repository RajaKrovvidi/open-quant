...
from open_quant.datetime import date
from open_quant.session import OqSession
from open_quant.target.common import Enum
...
class Factor:
    ...
    def __get_dataset_trial_appendage(self):
        availability_response = [model_dataset for model_dataset in
                                 OqSession.current._get(f'/data/measures/{self.risk_model_id}/availability?entityType'
