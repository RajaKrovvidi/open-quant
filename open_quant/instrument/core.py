...
from open_quant.api.oq.parser import OqParserApi
from open_quant.api.oq.risk import OqRiskApi
from open_quant.base import get_enum_value, InstrumentBase, Priceable, Scenario
from open_quant.common import AssetClass, AssetType, XRef, RiskMeasure
from open_quant.markets import HistoricalPricingContext, MarketDataCoordinate, PricingContext
from open_quant.priceable import PriceableImpl
from open_quant.risk import FloatWithInfo, DataFrameWithInfo, SeriesWithInfo, ResolvedInstrumentValues, \
    DEPRECATED_MEASURES
from open_quant.risk.results import ErrorValue, MultipleRiskMeasureFuture, PricingFuture, MultipleScenarioFuture
from open_quant.target.common import MultiScenario
...
class Instrument(PriceableImpl, InstrumentBase):
    ...
    def __asset_class_and_type_to_instrument(cls):
        if not cls.__instrument_mappings:
            import open_quant.target.instrument as instrument_
