...
from open_quant.api.oq.content import GsContentApi, OrderBy
from open_quant.session import OqSession, Environment
from open_quant.target.content import GetManyContentsResponse
from open_quant.test.fixtures.content import ContentFixtures
...
def test_get_contents(
    ...
    with mock.patch.object(OqSession, '_get', return_value=contents) as mock_method:
        # Act
