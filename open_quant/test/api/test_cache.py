...
from open_quant.instrument import IRSwap, IRSwaption
from open_quant.markets import HistoricalPricingContext, PricingCache, PricingContext
...
def test_cache_addition_removal():
    ...
    with mock.patch('open_quant.api.oq.risk.OqRiskApi._exec') as mocker:
