...
from open_quant.api.oq.assets import AssetType
...
def test_get_asset_positions_data(mocker):
    ...
    OqSession.current._get.assert_called_with('/indices/{id}/positions/data?startDate={start_date}&endDate={end_date}'.
