...
from open_quant.risk import IRVega, AggregationLevel
...
def test_display_options(mocker):
    ...
    assert open_quant.config.display_options.show_na is False
    open_quant.config.display_options.show_na = True
    assert open_quant.config.display_options.show_na is True
    ...
    open_quant.config.display_options = DisplayOptions()
