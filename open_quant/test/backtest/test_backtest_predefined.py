...
import open_quant.backtests.predefined_asset_engine
import datetime as dt
from open_quant.backtests.actions import AddTradeAction
from open_quant.backtests.strategy import Strategy
from open_quant.backtests.triggers import OrdersGeneratorTrigger, DateTriggerRequirements, DateTrigger
from open_quant.backtests.backtest_objects import PredefinedAssetBacktest
from open_quant.backtests.predefined_asset_engine import PredefinedAssetEngine
from open_quant.backtests.data_sources import DataManager
import pandas as pd
import numpy as np
from open_quant.data.core import DataFrequency
from open_quant.backtests.core import ValuationFixingType
from open_quant.instrument import IRBondFuture
from open_quant.backtests.order import OrderMarketOnClose, OrderTWAP, TimeWindow
from unittest import mock
import open_quant.datetime
...
def test_backtest_predefined():
    ...
    open_quant.backtests.predefined_asset_engine.is_business_day = mock.Mock(return_value=True)
    open_quant.backtests.predefined_asset_engine.business_day_offset = mock.Mock(return_value=mid)
