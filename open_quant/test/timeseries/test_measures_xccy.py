...
from open_quant.timeseries.measures_xccy import _currency_to_tdapi_crosscurrency_swap_rate_asset, \
...
def test_currency_to_tdapi_xccy_swap_rate_asset(mocker):
    ...
    bbid_mock = replace('open_quant.timeseries.measures_xccy.Asset.get_identifier', Mock())
...
def test_get_tdapi_crosscurrency_rates_assets(mocker):
    mock_asset_1 = OqAsset(asset_class='Rates', id='MAW8SAXPSKYA94E2', type_='XccySwapMTM', name='Test_asset')
    mock_asset_2 = OqAsset(asset_class='Rates', id='MATDD783JM1C2GGD', type_='XccySwapMTM', name='Test_asset')
...
def test_crosscurrency_swap_rate(mocker):
    ...
    xrefs = replace('open_quant.timeseries.measures.SecurityMaster.get_asset', Mock())
    ...
    xrefs = replace('open_quant.timeseries.measures.Asset.get_identifier', Mock())
    xrefs.return_value = 'GBP'
    xrefs = replace('open_quant.timeseries.measures_xccy._check_crosscurrency_rateoption_type', Mock())
    ...
    xrefs = replace('open_quant.timeseries.measures.Asset.get_identifier', Mock())
    xrefs.return_value = 'GBP'
    identifiers = replace('open_quant.timeseries.measures_xccy._get_tdapi_crosscurrency_rates_assets', Mock())
