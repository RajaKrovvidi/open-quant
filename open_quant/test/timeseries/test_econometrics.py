...
from open_quant.timeseries import *
from open_quant.timeseries.econometrics import _get_ratio
...
def test_sharpe_ratio():
    ...
    replace = Replacer()
    er = replace('open_quant.timeseries.econometrics.excess_returns', Mock())
