...
import open_quant.timeseries.measures_reports as mr
from open_quant.api.oq.assets import OqTemporalXRef
from open_quant.api.oq.data import MarketDataResponseFrame
from open_quant.data.core import DataContext
from open_quant.errors import MqValueError
from open_quant.markets.portfolio_manager import CustomAUMDataPoint
from open_quant.markets.report import PerformanceReport, ThematicReport
from open_quant.markets.securities import Stock
from open_quant.models.risk_model import FactorRiskModel as Factor_Risk_Model
from open_quant.target.common import ReportParameters, XRef
from open_quant.target.portfolios import RiskAumSource
from open_quant.target.reports import Report, PositionSourceType, ReportType
from open_quant.target.risk_models import RiskModel, RiskModelCoverage, RiskModelTerm, RiskModelUniverseIdentifier
...
def mock_risk_model():
    ...
    mock = replace('open_quant.api.oq.risk_models.GsRiskModelApi.get_risk_model', Mock())
...
def test_factor_exposure():
    ...
    mock = replace('open_quant.api.oq.reports.GsReportApi.get_report', Mock())
    mock.return_value = factor_risk_report

    # mock getting report factor data
    mock = replace('open_quant.api.oq.reports.GsReportApi.get_factor_risk_report_results', Mock())
    mock.return_value = factor_data

    # mock getting risk model dates
    mock = replace('open_quant.api.oq.risk_models.GsRiskModelApi.get_risk_model_dates', Mock())
    mock.return_value = ['2010-01-01']

    # mock getting risk model factor category
    mock = replace('open_quant.api.oq.risk_models.GsFactorRiskModelApi.get_risk_model_data', Mock())
    mock.return_value = {
        'results': [{
            'factorData': [{
                'factorId': 'factor_id',
    ...
    mock = replace('open_quant.api.oq.risk_models.GsFactorRiskModelApi.get_risk_model_factor_data', Mock())
    mock.return_value = [{
...
def test_factor_exposure_percent():
    ...
    mock = replace('open_quant.markets.portfolio_manager.PortfolioManager.get_aum_source', Mock())
    mock.return_value = RiskAumSource.Custom_AUM

    with DataContext(datetime.date(2020, 11, 23), datetime.date(2020, 11, 25)):
        # mock getting aum
        mock = replace('open_quant.markets.portfolio_manager.PortfolioManager.get_custom_aum', Mock())
...
def test_factor_pnl_percent():
    ...
    with DataContext(datetime.date(2020, 11, 23), datetime.date(2020, 11, 25)):
        ...
        mock = replace('open_quant.markets.portfolio_manager.PortfolioManager.get_performance_report', Mock())
        mock.return_value = PerformanceReport(id='ID')

        # mock getting aum
        mock = replace('open_quant.markets.report.PerformanceReport.get_long_exposure', Mock())
    ...
    with DataContext(datetime.date(2020, 11, 23), datetime.date(2020, 11, 25)):
        ...
        # mock getting aum
        mock = replace('open_quant.markets.report.PerformanceReport.get_short_exposure', Mock())
    ...
    with DataContext(datetime.date(2020, 11, 23), datetime.date(2020, 11, 25)):
        ...
        # mock getting aum
        mock = replace('open_quant.markets.report.PerformanceReport.get_gross_exposure', Mock())
    ...
    with DataContext(datetime.date(2020, 11, 23), datetime.date(2020, 11, 25)):
        ...
        # mock getting aum
        mock = replace('open_quant.markets.report.PerformanceReport.get_net_exposure', Mock())
...
def test_normalized_performance():
    ...
    mock = replace('open_quant.api.oq.portfolios.GsPortfolioApi.get_reports', Mock())
    mock.return_value = [
    ...
    mock = replace('open_quant.markets.report.PerformanceReport.get_portfolio_constituents', Mock())
    mock.return_value = MarketDataResponseFrame(data=constituents_data)

    # mock PerformanceReport.get()
    mock = replace('open_quant.markets.report.PerformanceReport.get', Mock())
...
def test_thematic_exposure():
    ...
    mock = replace('open_quant.markets.report.ThematicReport.get', Mock())
    mock.return_value = ThematicReport(id='report_id')

    # mock getting thematic exposure
    mock = replace('open_quant.markets.report.ThematicReport.get_thematic_exposure', Mock())
...
def test_thematic_beta():
    ...
    # mock getting thematic exposure
    mock = replace('open_quant.markets.report.ThematicReport.get_thematic_betas', Mock())
    mock.return_value = pd.DataFrame(thematic_data)
