...
import open_quant.timeseries.measures_risk_models as mrm
...
def test_factor_zscore():
    ...
    mock = replace('open_quant.markets.securities.Asset.get_identifier', Mock())
    ...
    mock = replace('open_quant.models.risk_model.MarqueeRiskModel.get_data', Mock())
    mock.return_value = {
        'results': [
            {
                'date': '2020-01-01',
...
def test_factor_covariance():
    ...
    mock = replace('open_quant.markets.factor.Factor.covariance', Mock())
...
def test_factor_volatility():
    ...
    # mock getting covariances
    mock = replace('open_quant.markets.factor.Factor.variance', Mock())
    mock.return_value = mock_covariance_curve
...
def test_factor_performance():
    ...
    mock = replace('open_quant.markets.factor.Factor.returns', Mock())
