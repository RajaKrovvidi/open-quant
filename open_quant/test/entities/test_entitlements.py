...
from open_quant.entities.entitlements import Group, Entitlements, User, EntitlementBlock
...
from open_quant.target.reports import User as TargetUser
...
def get_fake_user():
    ...
    replace = Replacer()
    mock = replace('open_quant.api.oq.users.GsUsersApi.get_users', Mock())
    mock.return_value = [user]
    user = User.get(email='jane.doe@oq.com')
    replace.restore()
