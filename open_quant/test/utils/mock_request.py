...
class MockRequest:
    ...
    def __init__(self, mocker, save_files=False, paths=None, application='oq-quant'):
    ...
    def __enter__(self):
        if self.save_files:
            OqSession.use(Environment.PROD, None, None, application=self.application)
            ...
            OqSession.use(Environment.PROD, 'fake_client_id', 'fake_secret', application=self.application)
