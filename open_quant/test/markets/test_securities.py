...
from open_quant.base import EnumBase
from open_quant.markets.securities import *
...
def test_get_security(mocker):
    mocker.patch.object(OqSession, 'default_value', return_value=OqSession.get(Environment.QA, 'client_id', 'secret'))
    ...
    mocker.patch.object(OqSession.current, '_get', side_effect=[mock_response, mock_identifier_history_response])
...
def test_get_security_fields(mocker):
    ...
    mocker.patch.object(OqSession.current, '_get', side_effect=[mock_response, mock_identifiers_response])
...
def test_get_identifiers(mocker):
    ...
    mocker.patch.object(OqSession.current, '_get', side_effect=[assets, ids_gs, ids_ap])
    with SecMasterContext():
...
def test_get_all_identifiers(mocker):
    ...
    mocker.patch.object(
        ...
        return_value=OqSession.get(
            ...
            'client_id',
            'secret'))
    mocker.patch.object(OqSession.current, '_get', side_effect=[p1, p2, p3])
    with SecMasterContext():
...
def test_get_all_identifiers_with_assetTypes_not_none(mocker):
    ...
    mocker.patch.object(OqSession.current, '_get', side_effect=get_identifiers_byte)
    with SecMasterContext():
...
def test_offset_key(mocker):
    ...
    mocker.patch.object(
        ...
        return_value=OqSession.get(
            ...
            'client_id',
            'secret'))
    mocker.patch.object(OqSession.current, '_get', side_effect=fetch)
    with SecMasterContext():
...
def test_map_identifiers(mocker):
    ...
    mocker.patch.object(OqSession.current, '_get', side_effect=[mock2, mock2])
...
def test_map_identifiers_change(mocker):
    ...
    mocker.patch.object(OqSession.current, '_get', side_effect=[mock])
...
def test_secmaster_map_identifiers_with_passed_input_types(mocker):
    ...
    mocker.patch.object(OqSession.current, '_get',
