...
from open_quant.api.oq.thematics import GsThematicApi
from open_quant.markets.report import FactorRiskReport, PerformanceReport, ThematicReport, flatten_results_into_df
from open_quant.session import *
from open_quant.target.reports import ReportStatus, PositionSourceType, ReportType, ReportParameters, Report
...
def test_get_factor_pnl(mocker):
    ...
    mocker.patch.object(
        ...
        return_value=OqSession.get(
            ...
            'client_id',
            'secret'))
    mocker.patch.object(OqSession.current, '_get', return_value=factor_risk_results)
