...
from open_quant.api.oq.carbon import GsCarbonApi, CarbonTargetCoverageCategory, CarbonScope, \
    CarbonEmissionsAllocationCategory, CarbonEmissionsIntensityType, CarbonCard, CarbonCoverageCategory, \
    CarbonEntityType
from open_quant.api.oq.esg import GsEsgApi, ESGMeasure
from open_quant.api.oq.portfolios import GsPortfolioApi
from open_quant.api.oq.reports import GsReportApi
from open_quant.entities.entitlements import Entitlements, User, EntitlementBlock
from open_quant.markets.portfolio_manager import PortfolioManager
from open_quant.markets.report import FactorRiskReport, PerformanceReport
from open_quant.models.risk_model import MacroRiskModel, FactorType, UniverseIdentifier, CoverageType, Term
from open_quant.session import OqSession, Environment
from open_quant.target.portfolios import Portfolio as TargetPortfolio
from open_quant.target.reports import ReportStatus, PositionSourceType, ReportType, Report
import pandas as pd
import numpy as np
...
def test_get_schedule_dates(mocker):
    ...
    mocker.patch.object(
        ...
        return_value=OqSession.get(
            ...
            'client_id',
            'secret'))
    mocker.patch.object(OqSession.current, '_get', return_value={'startDate': '2019-01-01', 'endDate': '2020-01-02'})
...
def test_set_entitlements(mocker):
    ...
    mocker.patch.object(OqSession, '_get',
                        return_value=mock_portfolio)
    mocker.patch.object(GsPortfolioApi, 'get_position_dates',
...
def test_get_macro_exposure(mocker):
    ...
    mocker.patch.object(OqAssetApi, "get_many_assets_data_scroll", return_value=assets_data)
