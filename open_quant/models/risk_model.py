...
from open_quant.api.oq.risk_models import GsFactorRiskModelApi, GsRiskModelApi
...
from open_quant.models.risk_model_utils import build_asset_data_map, build_factor_data_map, \
...
from open_quant.target.risk_models import RiskModel as RiskModelBuilder, RiskModelEventType, RiskModelData, \
...
class MarqueeRiskModel(RiskModel):
    ...
    def get_dates(self, start_date: dt.date = None, end_date: dt.date = None, event_type: RiskModelEventType = None) \
        ...
        **Examples**
        ...
        >>> from open_quant.models.risk_model import FactorRiskModel, RiskModelEventType
        >>> import datetime as dt
        >>>
    ...
    def get_calendar(self, start_date: dt.date = None, end_date: dt.date = None) -> RiskModelCalendar:
        ...
        **Examples**
        ...
        >>> from open_quant.models.risk_model import FactorRiskModel
        >>> import datetime as dt
        >>>
        >>> start_date = dt.date(2022, 1, 1)
        >>> end_date = dt.date(2022, 5, 2)
    ...
    def get_asset_universe(self,
        ...
        **Examples**
        ...
        >>> from open_quant.models.risk_model import FactorRiskModel, DataAssetsRequest, \
    ...
    def get_many_factors(self,
        ...
        **Examples**
        ...
        >>> from open_quant.models.risk_model import FactorRiskModel, FactorType
        >>> import datetime as dt
        >>>
        >>> start_date = dt.date(2022, 1, 1)
        >>> end_date = dt.date(2022, 5, 2)
    ...
    def get_specific_risk(self,
        ...
        **Examples**
        ...
        >>> from open_quant.models.risk_model import MacroRiskModel, DataAssetsRequest, \
        ...                      RiskModelUniverseIdentifierRequest as UniverseIdentifier
        >>> import datetime as dt
        >>>
        >>> start_date = dt.date(2022, 1, 1)
...
class MacroRiskModel(MarqueeRiskModel):
    ...
    def get_factor_standard_deviation(self,
        ...
        **Examples**
        ...
        >>> from open_quant.models.risk_model import MacroRiskModel
        >>> import datetime as dt
        >>>
        >>> start_date = dt.date(2022, 1, 1)
        >>> end_date = dt.date(2022, 5, 2)
