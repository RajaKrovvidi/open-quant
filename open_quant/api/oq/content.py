...
from open_quant.target.content import ContentResponse, GetManyContentsResponse
...
class GsContentApi:
    ...
    def get_contents(
        ...
        **Examples**
        ...
        >>> from open_quant.api.oq.content import GsContentApi
        >>> from open_quant.session import OqSession
        >>>
        >>> OqSession.use()
        ...
        contents = OqSession.current._get(f'/content{query_string}', cls=GetManyContentsResponse)
