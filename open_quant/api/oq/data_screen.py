...
class GsDataScreenApi:
    ...
    def get_screens(cls) -> Tuple[AnalyticsScreen, ...]:
        ...
        """
        return OqSession.current._get('/data/screens', cls=AnalyticsScreen)['results']
    ...
    def get_screen(cls, screen_id: str) -> AnalyticsScreen:
        ...
        """
        return OqSession.current._get('/data/screens/{id}'.format(id=screen_id), cls=AnalyticsScreen)
    ...
    def delete_screen(cls, screen_id: str) -> None:
        ...
        :return: None
        """
        return OqSession.current._delete('/data/screens/{id}'.format(id=screen_id))
    ...
    def create_screen(cls, screen: AnalyticsScreen) -> AnalyticsScreen:
        ...
        return OqSession.current._post('/data/screens', screen, request_headers=request_headers, cls=AnalyticsScreen)
    ...
    def filter_screen(cls, screen_id: str, filter_request: FilterRequest) -> Tuple[DataRow, ...]:
        ...
        """
        request_headers = {'Content-Type': 'application/json;charset=utf-8'}
        return OqSession.current._post('/data/screens/{id}/filter'.format(id=screen_id), filter_request,
    ...
    def update_screen(cls, screen_id: str, screen: AnalyticsScreen) -> AnalyticsScreen:
        ...
        request_headers = {'Content-Type': 'application/json;charset=utf-8'}
        return OqSession.current._put('/data/screens/{id}'.format(id=screen_id), screen,
