...
from open_quant.target.base_screener import Screener
...
class GsBaseScreenerApi:
    ...
    def get_screeners(cls) -> Tuple[Screener, ...]:
        ...
        """
        return OqSession.current._get('/data/screeners', cls=Screener)['results']
    ...
    def get_screener(cls, screener_id: str) -> Screener:
        ...
        with screener_id.
        """
        return OqSession.current._get('/data/screeners/{id}'.format(id=screener_id), cls=Screener)
    ...
    def create_screener(cls, screener: Screener) -> Screener:
        ...
        return OqSession.current._post('/data/screeners', screener, request_headers=request_headers, cls=Screener)
    ...
    def edit_screener(cls, screener_id: str, screener: Screener) -> Screener:
        ...
        request_headers = {'Content-Type': 'application/json;charset=utf-8'}
        return OqSession.current._put('/data/screeners/{id}'.format(id=screener_id), screener,
    ...
    def publish_to_screener(cls, screener_id: str, data: Dict[str, List[Dict[str, Any]]]) \
        ...
        """
        request_headers = {'Content-Type': 'application/json;charset=utf-8'}
        return OqSession.current._post('/data/screeners/{id}/publish'.format(id=screener_id), data,
    ...
    def clear_screener(cls, screener_id: str) -> Dict[str, Any]:
        ...
        """
        request_headers = {'Content-Type': 'application/json;charset=utf-8'}
        return OqSession.current._post('/data/screeners/{id}/clear'.format(id=screener_id), {},
    ...
    def delete_screener(cls, screener_id: str) -> None:
        ...
        :return: None
        """
        return OqSession.current._delete('/data/screeners/{id}'.format(id=screener_id))
