...
from open_quant.base import RiskKey, Sentinel
from open_quant.risk import ErrorValue, RiskRequest
from open_quant.risk.result_handlers import result_handlers
    ...
    def run(cls,
        ...
        async def run_async(current_span):
            ...
            Thread(daemon=True,
                   ...
                   args=(outstanding_requests, responses, raw_results, OqSession.current, loop, current_span)).start()
