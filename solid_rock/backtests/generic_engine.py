...
from solid_rock import risk
from solid_rock.backtests.action_handler import ActionHandlerBaseFactory, ActionHandler
from solid_rock.backtests.backtest_engine import BacktestBaseEngine
from solid_rock.backtests.backtest_utils import make_list, CalcType, get_final_date
from solid_rock.backtests.backtest_objects import BackTest, ScalingPortfolio, CashPayment, Hedge
from solid_rock.backtests.actions import Action, AddTradeAction, HedgeAction, EnterPositionQuantityScaledAction, \
...
from solid_rock.datetime.relative_date import RelativeDateSchedule
from solid_rock.instrument import Instrument
from solid_rock.markets.portfolio import Portfolio
from solid_rock.markets import PricingContext, HistoricalPricingContext
from solid_rock.risk import Price
from solid_rock.risk.results import PortfolioRiskResult
from solid_rock.target.backtests import BacktestTradingQuantityType
from solid_rock.common import ParameterisedRiskMeasure
...
class GenericEngine(BacktestBaseEngine):
    ...
    def run_backtest(self, strategy, start=None, end=None, frequency='1m', states=None, risks=Price,
                     show_progress=True, csa_term=None, visible_to_sr=False, initial_value=0, result_ccy=None,
        ...
        using solid_rock.datetime.relative_date.RelativeDateSchedule
        ...
        :param visible_to_sr: are the contents of risk requests visible to GS (defaults to False)
