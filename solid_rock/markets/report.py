...
from solid_rock.api.sr.reports import GsReportApi, OrderType, FactorRiskTableMode
from solid_rock.api.sr.thematics import Region, GsThematicApi, ThematicMeasure
from solid_rock.datetime import business_day_offset
from solid_rock.errors import MqValueError
from solid_rock.markets.report_utils import _get_ppaa_batches
from solid_rock.target.common import ReportParameters, Currency
from solid_rock.target.coordinates import MDAPIDataBatchResponse
from solid_rock.target.data import DataQuery, DataQueryResponse
from solid_rock.target.reports import Report as TargetReport, ReportType, PositionSourceType, ReportStatus
...
class Report:
    ...
    def run(self,
        ...
        while counter > 0:
            try:
                ...
                raise MqValueError(
                    ...
                    'Marquee Analytics team at sr-marquee-analytics-support@sr.com')
            except IndexError:
                counter -= 1
        ...
        raise MqValueError(f'Your report {self.id} is taking longer to run than expected. '
                           'Please reach out to the Marquee Analytics team at sr-marquee-analytics-support@sr.com '
                           'for assistance.')
