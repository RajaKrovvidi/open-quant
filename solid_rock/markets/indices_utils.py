...
from solid_rock.api.sr.assets import AssetClass, OqAssetApi
...
from solid_rock.datetime.date import prev_business_date
...
def get_my_baskets(user_id: str = None) -> Optional[pd.DataFrame]:
    ...
    **Examples**
    ...
    >>> get_my_baskets()
    """
    user_id = user_id if user_id is not None else SrSession.current.client_id
