...
from solid_rock.api.sr.assets import Currency, OqAsset, OqAssetApi
...
from solid_rock.markets.securities import Asset, AssetType
from solid_rock.markets.indices_utils import *
from solid_rock.target.data import DataQuery
from solid_rock.entities.tree_entity import AssetTreeNode, TreeHelper
...
class Index(Asset, PositionedEntity):
    ...
    def get_latest_constituent_instruments(self) -> Tuple[Instrument]:
        ...
        **Examples**
        ...
        return OqAssetApi.get_instruments_for_positions(self.get_latest_position_set().to_target().positions)
    ...
    def get_constituent_instruments_for_date(self,
        ...
        **Examples**
        ...
        return OqAssetApi.get_instruments_for_positions(self.get_position_set_for_date(date).to_target().positions)
    ...
    def get_constituent_instruments(self,
        ...
        **Examples**
        ...
        return [OqAssetApi.get_instruments_for_positions(position_set.to_target().positions)
