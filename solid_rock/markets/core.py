...
from solid_rock.base import InstrumentBase, RiskKey, Scenario, get_enum_value
from solid_rock.common import PricingLocation, RiskMeasure
from solid_rock.context_base import ContextBaseWithDefault
from solid_rock.datetime.date import business_day_offset, today
from solid_rock.risk import CompositeScenario, DataFrameWithInfo, ErrorValue, FloatWithInfo, MarketDataScenario, \
    StringWithInfo
from solid_rock.risk.results import PricingFuture
from solid_rock.session import SrSession
from solid_rock.target.common import PricingDateAndMarketDataAsOf
from solid_rock.target.risk import RiskPosition, RiskRequest, RiskRequestParameters
from solid_rock.tracing import Tracer
...
class PricingContext(ContextBaseWithDefault):
    ...
    def __init__(self,
                 ...
                 is_batch: bool = None,
                 use_cache: bool = None,
                 visible_to_sr: Optional[bool] = None,
        ...
        :param visible_to_sr: are the contents of risk requests visible to SR (defaults to False)
        ...
        **Examples**
        ...
        >>> from solid_rock.instrument import IRCap
        >>> cap = IRCap('5y', 'GBP')
        >>>
        >>> with PricingContext():
        ...
        self.__visible_to_sr = visible_to_sr
    ...
    def __save_attrs_to(self, attr_dict):
        ...
        attr_dict['visible_to_sr'] = self.__visible_to_sr
    ...
    def _on_enter(self):
        ...
        self.__visible_to_sr = _inherit_if_not_init('visible_to_sr')
    ...
    def __reset_atts(self):
        ...
        self.__visible_to_sr = self.__attrs_on_entry.get('visible_to_sr')
    ...
    def __calc(self):
        ...
        if requests_by_provider:
            session = SrSession.current
            request_visible_to_sr = session.is_internal() if self.__visible_to_sr is None else self.__visible_to_sr
                    ...
                    for insts_chunk in [tuple(filter(None, i)) for i in
                        ...
                        for dates_chunk in [tuple(filter(None, i)) for i in
                            ...
                            requests.append(RiskRequest(
                                ...
                                request_visible_to_sr=request_visible_to_sr,
    ...
    @property
    def visible_to_sr(self) -> Optional[bool]:
        """Request contents visible to GS"""
        return self.__visible_to_sr
    ...
    def _calc(self, instrument: InstrumentBase, risk_key: RiskKey) -> PricingFuture:
        ...
        from solid_rock.instrument import DummyInstrument
...
class PositionContext(ContextBaseWithDefault):
    ...
    def __init__(self,
        ...
        **Examples**
        ...
        >>> from solid_rock.markets import PositionContext
        >>> import datetime
        >>>
