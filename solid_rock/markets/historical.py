...
from solid_rock.base import InstrumentBase, RiskKey
from solid_rock.common import RiskMeasure
from solid_rock.datetime.date import date_range, prev_business_date
from solid_rock.risk import RollFwd, MarketDataScenario
from solid_rock.risk.results import HistoricalPricingFuture, PricingFuture
...
class HistoricalPricingContext(PricingContext):
    ...
    def __init__(
        ...
        **Examples**
        ...
        """
        super().__init__(is_async=is_async, is_batch=is_batch, use_cache=use_cache, visible_to_sr=visible_to_sr,
    ...
    def __init__(
        ...
        **Examples** assuming today is between dt.date(2020, 7, 6) and dt.date(2020, 7, 14)
        ...
        super().__init__(start=start, end=end, calendars=calendars, dates=dates,
                         is_async=is_async, is_batch=is_batch, use_cache=use_cache, visible_to_sr=visible_to_sr,
