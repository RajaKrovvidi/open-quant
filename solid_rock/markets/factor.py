...
from solid_rock.datetime import date
from solid_rock.session import SrSession
from solid_rock.target.common import Enum
...
class Factor:
    ...
    def __get_dataset_trial_appendage(self):
        availability_response = [model_dataset for model_dataset in
                                 SrSession.current._get(f'/data/measures/{self.risk_model_id}/availability?entityType'
