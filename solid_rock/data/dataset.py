...
class PTPDataset(Dataset):
    ...
    **Example**
    ...
    >>> from solid_rock.data import PTPDataset
    >>> import datetime
    ...
    def sync(self):
        ...
        res = SrSession.current._post('/plots/datasets', payload=kwargs)
    ...
    def plot(self, open_in_browser: bool = True, field: Optional[str] = None) -> str:
        ...
        domain = SrSession.current.domain.replace('marquee.web', 'marquee')  # remove .web from prod domain
