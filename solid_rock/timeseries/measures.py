...
from solid_rock.data.fields import Fields
from solid_rock.data.log import log_debug, log_warning
from solid_rock.datetime.gscalendar import GsCalendar
from solid_rock.datetime.point import relative_date_add
from solid_rock.markets.securities import *
from solid_rock.markets.securities import Asset, AssetIdentifier, SecurityMaster, AssetType as SecAssetType
from solid_rock.target.common import AssetClass, AssetType
from solid_rock.timeseries import volatility, Window, Returns, sqrt, Basket, RelativeDate
from solid_rock.timeseries.helper import (
    log_return,
    plot_measure,
    _to_offset,
...
from solid_rock.timeseries.measures_helper import EdrDataReference, VolReference, preprocess_implied_vol_strikes_eq
...
def _var_swap_tenors(asset: Asset, request_id=None):
    ...
    body = SrSession.current._get(f"/data/markets/{aid}/availability")
