...
from solid_rock.timeseries.econometrics import volatility, correlation
from solid_rock.timeseries.helper import _create_enum, _tenor_to_month, _month_to_tenor
from solid_rock.timeseries.measures_helper import VolReference, preprocess_implied_vol_strikes_eq
from solid_rock import timeseries as ts
from .statistics import *
from ..api.sr.assets import OqAssetApi
from ..api.sr.data import GsDataApi, MarketDataResponseFrame
...
class Basket:
    ...
    def get_marquee_ids(self):
        if self._marquee_ids is None:
            ...
            assets = reversed(OqAssetApi.get_many_assets_data(bbid=self.bbids, fields=('id', 'bbid', 'rank'),
