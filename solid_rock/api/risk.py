...
from solid_rock.base import RiskKey, Sentinel
from solid_rock.risk import ErrorValue, RiskRequest
from solid_rock.risk.result_handlers import result_handlers
    ...
    def run(cls,
        ...
        async def run_async(current_span):
            ...
            Thread(daemon=True,
                   ...
                   args=(outstanding_requests, responses, raw_results, SrSession.current, loop, current_span)).start()
