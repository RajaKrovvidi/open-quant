...
from solid_rock.api.sr.assets import IdList
...
class GsIndexApi:
    ...
    def create(cls, inputs: CreateRequest) -> CreateRepsonse:
        ...
        return SrSession.current._post('/indices', payload=inputs, cls=response_cls)
    ...
    def edit(cls, id_: str, inputs: CustomBasketsEditInputs) -> CustomBasketsResponse:
        ...
        return SrSession.current._post(url, payload=inputs, cls=CustomBasketsResponse)
    ...
    def rebalance(cls, id_: str, inputs: RebalanceRequest) -> RebalanceResponse:
        ...
        return SrSession.current._post(url, payload=inputs, cls=response_cls)
    ...
    def last_rebalance_approval(cls, id_: str) -> ApprovalCustomBasketResponse:
        ...
        return SrSession.current._get(url, cls=ApprovalCustomBasketResponse)
    ...
    def validate_ticker(cls, ticker: str):
        ...
        SrSession.current._post(url, payload={'ticker': ticker})
    ...
    def update_risk_reports(cls, _id: str, inputs: CustomBasketRiskParams):
        ...
        return SrSession.current._post(url, payload=inputs)
