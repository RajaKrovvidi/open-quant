...
from solid_rock.target.content import ContentResponse, GetManyContentsResponse
...
class GsContentApi:
    ...
    def get_contents(
        ...
        **Examples**
        ...
        >>> from solid_rock.api.sr.content import GsContentApi
        >>> from solid_rock.session import SrSession
        >>>
        >>> SrSession.use()
        ...
        contents = SrSession.current._get(f'/content{query_string}', cls=GetManyContentsResponse)
