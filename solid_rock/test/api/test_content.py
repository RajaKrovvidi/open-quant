...
from solid_rock.api.sr.content import GsContentApi, OrderBy
from solid_rock.session import SrSession, Environment
from solid_rock.target.content import GetManyContentsResponse
from solid_rock.test.fixtures.content import ContentFixtures
...
def test_get_contents(
    ...
    with mock.patch.object(SrSession, '_get', return_value=contents) as mock_method:
        # Act
