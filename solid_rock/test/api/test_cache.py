...
from solid_rock.instrument import IRSwap, IRSwaption
from solid_rock.markets import HistoricalPricingContext, PricingCache, PricingContext
...
def test_cache_addition_removal():
    ...
    with mock.patch('solid_rock.api.sr.risk.OqRiskApi._exec') as mocker:
