...
from solid_rock.api.sr.assets import AssetType
...
def test_get_asset_positions_data(mocker):
    ...
    SrSession.current._get.assert_called_with('/indices/{id}/positions/data?startDate={start_date}&endDate={end_date}'.
