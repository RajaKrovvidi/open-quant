...
from solid_rock.entities.entitlements import Group, Entitlements, User, EntitlementBlock
...
from solid_rock.target.reports import User as TargetUser
...
def get_fake_user():
    ...
    replace = Replacer()
    mock = replace('solid_rock.api.sr.users.GsUsersApi.get_users', Mock())
    mock.return_value = [user]
    user = User.get(email='jane.doe@sr.com')
    replace.restore()
