...
from solid_rock.timeseries import *
from solid_rock.timeseries.econometrics import _get_ratio
...
def test_sharpe_ratio():
    ...
    replace = Replacer()
    er = replace('solid_rock.timeseries.econometrics.excess_returns', Mock())
