...
import solid_rock.timeseries.measures_risk_models as mrm
...
def test_factor_zscore():
    ...
    mock = replace('solid_rock.markets.securities.Asset.get_identifier', Mock())
    ...
    mock = replace('solid_rock.models.risk_model.MarqueeRiskModel.get_data', Mock())
    mock.return_value = {
        'results': [
            {
                'date': '2020-01-01',
...
def test_factor_covariance():
    ...
    mock = replace('solid_rock.markets.factor.Factor.covariance', Mock())
...
def test_factor_volatility():
    ...
    # mock getting covariances
    mock = replace('solid_rock.markets.factor.Factor.variance', Mock())
    mock.return_value = mock_covariance_curve
...
def test_factor_performance():
    ...
    mock = replace('solid_rock.markets.factor.Factor.returns', Mock())
