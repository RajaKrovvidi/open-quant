...
from solid_rock.timeseries.measures_xccy import _currency_to_tdapi_crosscurrency_swap_rate_asset, \
...
def test_currency_to_tdapi_xccy_swap_rate_asset(mocker):
    ...
    bbid_mock = replace('solid_rock.timeseries.measures_xccy.Asset.get_identifier', Mock())
...
def test_crosscurrency_swap_rate(mocker):
    ...
    xrefs = replace('solid_rock.timeseries.measures.SecurityMaster.get_asset', Mock())
    ...
    xrefs = replace('solid_rock.timeseries.measures.Asset.get_identifier', Mock())
    xrefs.return_value = 'GBP'
    xrefs = replace('solid_rock.timeseries.measures_xccy._check_crosscurrency_rateoption_type', Mock())
    ...
    xrefs = replace('solid_rock.timeseries.measures.Asset.get_identifier', Mock())
    xrefs.return_value = 'GBP'
    identifiers = replace('solid_rock.timeseries.measures_xccy._get_tdapi_crosscurrency_rates_assets', Mock())
