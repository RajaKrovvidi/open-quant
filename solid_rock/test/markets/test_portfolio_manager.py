...
from solid_rock.api.sr.carbon import GsCarbonApi, CarbonTargetCoverageCategory, CarbonScope, \
    CarbonEmissionsAllocationCategory, CarbonEmissionsIntensityType, CarbonCard, CarbonCoverageCategory, \
    CarbonEntityType
from solid_rock.api.sr.esg import GsEsgApi, ESGMeasure
from solid_rock.api.sr.portfolios import GsPortfolioApi
from solid_rock.api.sr.reports import GsReportApi
from solid_rock.entities.entitlements import Entitlements, User, EntitlementBlock
from solid_rock.markets.portfolio_manager import PortfolioManager
from solid_rock.markets.report import FactorRiskReport, PerformanceReport
from solid_rock.models.risk_model import MacroRiskModel, FactorType, UniverseIdentifier, CoverageType, Term
from solid_rock.session import SrSession, Environment
from solid_rock.target.portfolios import Portfolio as TargetPortfolio
from solid_rock.target.reports import ReportStatus, PositionSourceType, ReportType, Report
import pandas as pd
import numpy as np
...
def test_get_schedule_dates(mocker):
    ...
    mocker.patch.object(
        ...
        return_value=SrSession.get(
            ...
            'client_id',
            'secret'))
    mocker.patch.object(SrSession.current, '_get', return_value={'startDate': '2019-01-01', 'endDate': '2020-01-02'})
...
def test_set_entitlements(mocker):
    ...
    mocker.patch.object(SrSession, '_get',
                        return_value=mock_portfolio)
    mocker.patch.object(GsPortfolioApi, 'get_position_dates',
