...
from solid_rock.api.sr.thematics import GsThematicApi
from solid_rock.markets.report import FactorRiskReport, PerformanceReport, ThematicReport, flatten_results_into_df
from solid_rock.session import *
from solid_rock.target.reports import ReportStatus, PositionSourceType, ReportType, ReportParameters, Report
...
def test_get_factor_pnl(mocker):
    ...
    mocker.patch.object(
        ...
        return_value=SrSession.get(
            ...
            'client_id',
            'secret'))
    mocker.patch.object(SrSession.current, '_get', return_value=factor_risk_results)
