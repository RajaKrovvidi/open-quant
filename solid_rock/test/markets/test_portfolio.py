...
from solid_rock.instrument import IRSwap, IRSwaption, CurveScenario
from solid_rock.markets import HistoricalPricingContext, PricingContext, BackToTheFuturePricingContext, \
    historical_risk_key
from solid_rock.markets.portfolio import Portfolio
from solid_rock.risk.results import PortfolioPath, PortfolioRiskResult
from solid_rock.session import Environment, SrSession
from solid_rock.target.common import PositionSet
...
def set_session():
    ...
    SrSession.use(Environment.PROD, 'client_id', 'secret')
