...
from solid_rock.api.sr.assets import AssetClass, AssetType, OqAsset, OqAssetApi
...
from solid_rock.entities.entitlements import User
from solid_rock.errors import MqError
from solid_rock.markets.baskets import Basket, ErrorMessage
from solid_rock.markets.indices_utils import ReturnType
from solid_rock.markets.position_set import Position, PositionSet
from solid_rock.session import SrSession, Environment
from solid_rock.target.common import Entitlements as TargetEntitlements, \
    PositionSet as TargetPositionSet, Position as TargetPosition, ReportParameters, XRef
from solid_rock.target.indices import CustomBasketsResponse, CustomBasketRiskParams
from solid_rock.target.reports import Report, User as TargetUser
...
@mock.patch.object(SrSession.__class__, 'default_value')
def mock_session(mocker):
    """ Mock SrSession helper """
    mocker.return_value = SrSession.get(Environment.QA, 'client_id', 'secret')
