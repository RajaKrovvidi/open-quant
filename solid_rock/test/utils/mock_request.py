...
class MockRequest:
    ...
    def __enter__(self):
        if self.save_files:
            SrSession.use(Environment.PROD, None, None, application=self.application)
            ...
            SrSession.use(Environment.PROD, 'fake_client_id', 'fake_secret', application=self.application)
