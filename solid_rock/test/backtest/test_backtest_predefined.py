...
import solid_rock.backtests.predefined_asset_engine
import datetime as dt
from solid_rock.backtests.actions import AddTradeAction
from solid_rock.backtests.strategy import Strategy
from solid_rock.backtests.triggers import OrdersGeneratorTrigger, DateTriggerRequirements, DateTrigger
from solid_rock.backtests.backtest_objects import PredefinedAssetBacktest
from solid_rock.backtests.predefined_asset_engine import PredefinedAssetEngine
from solid_rock.backtests.data_sources import DataManager
import pandas as pd
import numpy as np
from solid_rock.data.core import DataFrequency
from solid_rock.backtests.core import ValuationFixingType
from solid_rock.instrument import IRBondFuture
from solid_rock.backtests.order import OrderMarketOnClose, OrderTWAP, TimeWindow
from unittest import mock
import solid_rock.datetime
...
def test_backtest_predefined():
    ...
    solid_rock.backtests.predefined_asset_engine.is_business_day = mock.Mock(return_value=True)
    solid_rock.backtests.predefined_asset_engine.business_day_offset = mock.Mock(return_value=mid)
