...
from solid_rock.analytics.common import TYPE, PROCESSOR, PARAMETERS, DATA_COORDINATE, \
    ENTITY, VALUE, DATE, DATETIME, PROCESSOR_NAME, ENTITY_ID, ENTITY_TYPE, PARAMETER, REFERENCE, RELATIVE_DATE, LIST
from solid_rock.analytics.common.enumerators import ScaleShape
from solid_rock.analytics.common.helpers import is_of_builtin_type, get_entity_rdate_key_from_rdate
from solid_rock.analytics.core.processor_result import ProcessorResult
from solid_rock.data import DataCoordinate, DataFrequency
from solid_rock.data.query import DataQuery, DataQueryType
from solid_rock.entities.entity import Entity
from solid_rock.target.common import Currency
from solid_rock.timeseries import Window, Returns, RelativeDate, DateOrDatetime
...
class BaseProcessor(metaclass=ABCMeta):
    ...
    def from_dict(cls, obj: Dict, reference_list: List):
        ...
        processor = getattr(__import__('solid_rock.analytics.processors', fromlist=['']), processor_name, None)
